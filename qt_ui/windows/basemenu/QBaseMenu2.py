...
class QBaseMenu2(QDialog):
    ...
    def update_intel_summary(self) -> None:
        ...
        stol_aircraft = self.cp.allocated_aircraft(parking_type_stol).total_present
        ...
        stol_parking = self.cp.total_aircraft_parking(parking_type_stol)
        ...
        self.intel_summary.setText(
            "\n".join(
                [
                    ...
                    f"{stol_aircraft}/{stol_parking} fixed wing ground start aircraft",
    ...
    def get_base_image(self):
        if (
            ...
            carrier_type = self.cp.get_carrier_group_type(always_supercarrier=False)
